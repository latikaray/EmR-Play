...
const ParentHomePage = () => {
  ...
  const parentingActivities = [
    ...
    {
      title: "SEL Activities Guide",
      description: "20+ social emotional learning activities to do at home",
      icon: Sparkles,
      path: "/parent/sel-activities-guide",
      color: "bg-fun-yellow",
      count: "22 activities",
      sample: "Gratitude Jar, Feeling Charades, Breathing Buddy"
    }
  ];
