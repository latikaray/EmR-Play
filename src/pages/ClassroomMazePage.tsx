        ...
        {!gameComplete && !gameLost && (
          <div className="flex justify-center">
            <div className="grid grid-cols-3 gap-2 w-fit">
              <div />
              <Button variant="outline" size="icon" aria-label="Move up" onClick={() => move(0, -1)} disabled={!!activeScenario || !!choiceResult}>
                <ArrowUp className="h-5 w-5" />
              </Button>
              <div />
              <Button variant="outline" size="icon" aria-label="Move left" onClick={() => move(-1, 0)} disabled={!!activeScenario || !!choiceResult}>
                <ArrowLeft className="h-5 w-5" />
              </Button>
              <Button variant="outline" size="icon" aria-label="Move down" onClick={() => move(0, 1)} disabled={!!activeScenario || !!choiceResult}>
                <ArrowDown className="h-5 w-5" />
              </Button>
              <Button variant="outline" size="icon" aria-label="Move right" onClick={() => move(1, 0)} disabled={!!activeScenario || !!choiceResult}>
